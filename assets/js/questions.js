...
let questions = [
  ...
  {
    question: "During their first visit to Diagon Alley, what flavor of ice cream did Hagrid buy for Harry?",
  ...
  {
    question: "Cedric Diggory let Harry use the prefect's bathroom in 'The Goblet of Fire.' What man's statue is next to the special lavatory entrance?",
  ...
  {
    question: "In 'Harry Potter And The Prisoner Of Azkaban', to what page number does Professor Snape ask his class to turn to?",
    optionA: "394",
    optionB: "350",
    optionC: "400",
    optionD: "384",
  ...
  {
    question: "What is the Quidditch foul where a player uses their elbows to hurt another player?",
    optionA: "Blagging",
    optionB: "Flacking",
    optionC: "Blatching",
    optionD: "Cobbing",
  ...
  {
    question: "What is the first line in the film, 'Harry Potter And The Philosopher's Stone'?",
  ...
  {
    question: "What Was The Exact Time That Harry & Hermione Went Back In Time To Using The Time-Turner? (Prisoner Of Azkaban film)",
    optionA: "6:30",
    optionB: "5:30",
    optionC: "8:30",
    optionD: "7:30",
  ...
  {
    question: "Which of these species is considered a 'being' rather than a beast or spirit under magical law?",
    optionA: "Leprechauns",
    optionB: "Merpeople",
    optionC: "Centaurs",
    optionD: "Veela",
  ...
  {
    question: "Which Of The Following Is NOT A Bertie Bott’s Every Flavour Bean?",
    optionA: "Tripe",
    optionB: "Onion",
    optionC: "Spinach",
    optionD: "Earwax",
